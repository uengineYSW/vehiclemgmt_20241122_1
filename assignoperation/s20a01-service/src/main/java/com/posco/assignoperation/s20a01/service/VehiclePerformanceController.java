...
import com.posco.assignoperation.s20a01.domain.vehiclePerformance.VehiclePerformanceService;
...
public class VehiclePerformanceController {
    ...
    @PostMapping(
        path = "/vehiclePerformances/RegisterDrivingLog/{registrationId}/registerDrivingLog"
    )
    ...
    public ResponseEntity<VehiclePerformance> searchVehiclePerformance(
        ...
        return ResponseEntity.ok(
            vehiclePerformanceService.searchVehiclePerformance(registrationId)
        );
    }
}
